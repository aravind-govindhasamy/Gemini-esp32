...
LV_FONT_DECLARE(ui_font_JetBrainsMono88);
LV_FONT_DECLARE(ui_font_JetBrainsMono40);
LV_FONT_DECLARE(ui_font_JetBrainsMono22);

extern const lv_font_t *jetbrains_88;
extern const lv_font_t *jetbrains_40;
extern const lv_font_t *jetbrains_22;

// SCREEN: ui_ScreenWeather
void ui_ScreenWeather_screen_init(void);
extern lv_obj_t *ui_ScreenWeather;
extern lv_obj_t *ui_WeatherClock;
extern lv_obj_t *ui_LabelTempVal;
extern lv_obj_t *ui_LabelHumVal;

// SCREEN: ui_ScreenStatus
void ui_ScreenStatus_screen_init(void);
extern lv_obj_t *ui_ScreenStatus;
