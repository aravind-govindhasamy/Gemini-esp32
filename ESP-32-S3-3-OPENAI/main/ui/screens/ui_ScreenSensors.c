...
void ui_ScreenSensors_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_ScreenSensors, &ui_img_setup_bg_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelSensorsTitle, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelSensorsTitle, &ui_font_PingFangEN20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelTempTitle, lv_color_hex(0xCCCCCC), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelTempTitle, &ui_font_PingFangEN16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LabelTempValue, &ui_font_PingFangEN20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelHumTitle, lv_color_hex(0xCCCCCC), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelHumTitle, &ui_font_PingFangEN16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_LabelHumValue, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelHumValue, &ui_font_PingFangEN20, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Back Button
    ui_ButtonSensorBack = lv_btn_create(ui_ScreenSensors);
    lv_obj_set_width(ui_ButtonSensorBack, 80);
    lv_obj_set_height(ui_ButtonSensorBack, 30);
    lv_obj_set_align(ui_ButtonSensorBack, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_y(ui_ButtonSensorBack, -20);
    lv_obj_set_style_bg_color(ui_ButtonSensorBack, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ButtonSensorBack, 50, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_event_cb(ui_ButtonSensorBack, ui_event_ButtonSensorBack, LV_EVENT_ALL, NULL);
    ...
    lv_obj_set_style_text_color(ui_LabelSensorBack, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelSensorBack, &ui_font_PingFangEN14, LV_PART_MAIN | LV_STATE_DEFAULT);
}
